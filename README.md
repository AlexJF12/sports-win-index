...
- **`season.png`** — the group's cumulative weighted index this year against their own **last 10 seasons**, day of year for day of year, so a bad start or a long climb shows up against the years that came before it. Past ten lines the year labels collide, so only the best and worst finishers are named and the rest stay an unlabelled gray field
